...
void math::vectorangles(const vec3_t& forward, vec3_t& angles)
{
	if (forward.y == 0.0f && forward.x == 0.0f) {
...
void math::anglevectors(const vec3_t& angles, vec3_t& forward, vec3_t& right, vec3_t& up) {
...
bool math::worldtoscreen(const vec3_t& origin, vec3_t& screen) {
